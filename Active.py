...
def server():
    try:
        database=requests.get("https://raw.githubusercontent.com/IBR4HIM-404/R4ND0M/main/Sarver.txt").text
    except:
    ...
    if "on" in database:
        ...
        os.system('espeak -a 300 " TOOL, IS, OFF "')
        print(" [✓] TOOL IS OFF 🚫")
        sys.exit()
    else:
        while True:
            os.system('espeak -a 300 " THE,  TOOL,  IS,  NOW, UPDATE"')
            print("[✓] THE TOOL IS NOW UPDATE 🤦")

server()
os.system('espeak -a 300 " UPDATE, CHECKING"')
print("[red][✓] UPDATE CHECKING ✅")
...
#    os.system('espeak -a 300 " Enter,  the,  user,  name,"')
#    username = input(' \033[0;92mEnter Username: ')
#    os.system('espeak -a 300 " Enter,  the,  tools,  password,"')
#    password = input(' \033[0;93mEnter Password: ')

#    if username == 'ibrahim' and password == 'ajijul':
#        os.system('espeak -a 300 " login,  Successfully,  bro,"')
#        print(' \033[0;92mYou login successful bro .')
#        break
#    else:
...
[Green]________    __      ________     __      _____  ___   
("      "\  |" \    /"       )   /""\    (\"   \|"  \  
 \___/   :) ||  |  (:   \___/   /    \   |.\\   \    | 
   /  ___/  |:  |   \___  \    /' /\  \  |: \.   \\  | 
  //  \__   |.  |    __/  \\  //  __'  \ |.  \    \. | 
 (:   / "\  /\  |\  /" \   :)/   /  \\  \|    \    \ | 
  \_______)(__\_|_)(_______/(___/    \___)\___|\____\) 
...
number=int(" +8801706407752")

devoloper_info={
    "Developer" :  'ZISAN VAU ',
    "Number" :  number,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/IBR4HIM-404',
    "Facebook" :  'facebook.com/ibrahim.tera.real.bap',
    }
...
def need(uid,pwx,fb,tl):
    ...
    sys.stdout.write(f"\r  \33[1;90m[\33[1;97mZISAN ✘D\33[1;92m | {'{:.1%}'.format(loop/int(tl))} | \33[1;97m{loop} \33[1;90m] \r "),
    sys.stdout.flush()
    try:
        for ps in pwx:
